...
class Ball:
    ...
    def draw(self):
        ...
        if position[3]>=self.canvas_height:
            ...
            canvas.create_text(300,100,text= "Game Over",font =("Paytone One",20),fill = '#fff')
            canvas.create_text(300,150,text ="Your Score is:",font =("Paytone One",20),fill = '#fff')
            canvas.create_text(300,190,text=n ,font =("Verdana",20),fill = '#fff')
