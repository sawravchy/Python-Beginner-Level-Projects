...
class Ball:
    ...
    def hit_paddle(self, position):
        ...
        if position[1] >= paddle_position[1] and position[
                1] <= paddle_position[3]:
            if position[0] >= paddle_position[0] and position[
                    0] <= paddle_position[2]:
                return True
            return False
    ...
    for i in range(0, 10):
        if counter == 10 or counter1 == 10:
            if counter < counter1:
                ...
                canvas.create_text(250,
                                   280,
                                   text="Orange Paddle : " + str(counter1),
                                   font=("Paytone One", 20),
                                   fill='#F18A35')
                canvas.create_text(250,
                                   320,
                                   text="Yellow Paddle : " + str(counter),
                                   font=("Paytone One", 20),
                                   fill='#F2CE22')
